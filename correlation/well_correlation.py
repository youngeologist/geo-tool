...
def main():
    ...
    ShaleBaseLine1 = cols[0].slider('Shale Base Line-1', min_value=0, max_value=150, value=75)
    ShaleBaseLine2 = cols[1].slider('Shale Base Line-2', min_value=0, max_value=150, value=75)
    ShaleBaseLine3 = cols[2].slider('Shale Base Line-3', min_value=0, max_value=150, value=75)
    ShaleBaseLine4 = cols[3].slider('Shale Base Line-4', min_value=0, max_value=150, value=75)
